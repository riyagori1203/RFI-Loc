...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def plotfile(self, pos_dict,delay_dict):
        ...
        for i in range(0,l):   #scatter plot for antennas
            self.axes.scatter(pos_dict[i][0],pos_dict[i][1])
            baseline=delay_dict[i][1]
            ant2=(baseline - 65536) % 2048 - 1
            ant1 = ((baseline - 65536) - (ant2 + 1))//2048 -1
            print(ant1,ant2)
            print("ant1 position is ", pos_dict[ant1][0],pos_dict[ant1][1])
            print("ant2 position is ", pos_dict[ant2][0],pos_dict[ant2][1])
            xyp=self.hyperbola(delay_dict[i][2],pos_dict[ant1][0],pos_dict[ant1][1],pos_dict[ant2][0],pos_dict[ant2][1],10000,200) #self,delay_s, x0,x1,y0,y1, range, pts
            self.axes.plot(xyp[0, :],xyp[1, :],linestyle='solid',picker=5, label=i,pickradius=10)
    ...
    # print(a)
        ...
        def groupbylist(event): 
            # print(self.view.figure.canvas.cursor().shape())
    ...
    def load_file(self):
        ...
        if self.file_path[0]:
            ...
            if fileType == "npz":
                data = np.load('output_records.npz')
                print(data.files)
