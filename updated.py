...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def plotfile(self, pos_dict,delay_dict):
        ...
        for i in range(0,l):
            ...
            xyp[2,:] = (xyp[2,:] - np.min(xyp[2,:]))/(np.max(xyp[2,:]) - np.min(xyp[2,:]))
            
            # lc = LineCollection(segments, linewidths=0.5, colors='k',alpha=(xyp[2,:]))
            ...
            self.axes.plot(xyp[0, :],xyp[1, :],c=viridis_r(norm(strength)), lw=1,picker=5, label=i,pickradius=5 ,alpha=(xyp[2,i]))
